...
public static class PodlordLocalizer
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["sources.importPlaceholder"] = "path, directory, or pasted kubeconfig YAML; empty opens file picker",
    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Catalog =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["de"] = WithEnglish("de", new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["filters.title"] = "FILTER", ["filters.problems"] = "Probleme", ["filters.activity"] = "Aktivitat", ["settings.title"] = "EINSTELLUNGEN", ["settings.language"] = "Sprache",
                ["resource.noMatchingTitle"] = "Keine passenden Ressourcen", ["resource.loadingTitle"] = "Ressourcen werden geladen", ["resource.emptyTitle"] = "Keine Ressourcen geladen", ["source.noSession"] = "Keine Kubernetes-Sitzung ausgewahlt.", ["status.settingsSaved"] = "Einstellungen gespeichert."
            }),
            ["es"] = WithEnglish("es", new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["resource.noMatchingTitle"] = "No hay recursos coincidentes", ["resource.loadingTitle"] = "Cargando recursos", ["source.noSession"] = "No hay sesion de Kubernetes seleccionada.", ["status.settingsSaved"] = "Ajustes guardados."
            }),
            ["fr"] = WithEnglish("fr", new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ["nav.search"] = "Rechercher", ["nav.resources"] = "RESSOURCES", ["nav.graph"] = "GRAPHE", ["nav.events"] = "EVENEMENTS", ["nav.ports"] = "PORTS", ["nav.settings"] = "PARAMETRES",
                ["filters.title"] = "FILTRES", ["filters.problems"] = "Problemes", ["filters.activity"] = "Activite", ["settings.title"] = "PARAMETRES", ["settings.language"] = "Langue",
                ["resource.noMatchingTitle"] = "Aucune ressource correspondante", ["resource.loadingTitle"] = "Chargement des ressources", ["source.noSession"] = "Aucune session Kubernetes selectionnee.", ["status.settingsSaved"] = "Parametres enregistres."
            }),
            ["pt-BR"] = WithEnglish("pt-BR", new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ["nav.search"] = "Buscar", ["nav.resources"] = "RECURSOS", ["nav.graph"] = "GRAFO", ["nav.events"] = "EVENTOS", ["nav.ports"] = "PORTAS", ["nav.settings"] = "CONFIGURACOES",
                ["filters.title"] = "FILTROS", ["filters.problems"] = "Problemas", ["filters.activity"] = "Atividade", ["settings.title"] = "CONFIGURACOES", ["settings.language"] = "Idioma",
                ["resource.noMatchingTitle"] = "Nenhum recurso encontrado", ["resource.loadingTitle"] = "Carregando recursos", ["source.noSession"] = "Nenhuma sessao Kubernetes selecionada.", ["status.settingsSaved"] = "Configuracoes salvas."
            }),
            ["it"] = WithEnglish("it", new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["filters.title"] = "FILTRI", ["filters.problems"] = "Problemi", ["filters.activity"] = "Attivita", ["settings.title"] = "IMPOSTAZIONI", ["settings.language"] = "Lingua",
            ...
            ["pl"] = WithEnglish("pl", new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["filters.title"] = "FILTRY", ["filters.problems"] = "Problemy", ["filters.activity"] = "Aktywnosc", ["settings.title"] = "USTAWIENIA", ["settings.language"] = "Jezyk",
                ["resource.noMatchingTitle"] = "Brak pasujacych zasobow", ["resource.loadingTitle"] = "Ladowanie zasobow", ["source.noSession"] = "Nie wybrano sesji Kubernetes.", ["status.settingsSaved"] = "Ustawienia zapisane."
            }),
            ...
            ["tr"] = WithEnglish("tr", new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["filters.title"] = "FILTRELER", ["filters.problems"] = "Sorunlar", ["filters.activity"] = "Etkinlik", ["settings.title"] = "AYARLAR", ["settings.language"] = "Dil",
                ["resource.noMatchingTitle"] = "Eslesen kaynak yok", ["resource.loadingTitle"] = "Kaynaklar yukleniyor", ["source.noSession"] = "Kubernetes oturumu secilmedi.", ["status.settingsSaved"] = "Ayarlar kaydedildi."
            }),
            ...
            {
                ["nav.search"] = "Tim", ["nav.resources"] = "TAI NGUYEN", ["nav.graph"] = "DO THI", ["nav.events"] = "SU KIEN", ["nav.ports"] = "CONG", ["nav.settings"] = "CAI DAT",
                ["filters.title"] = "BO LOC", ["filters.problems"] = "Su co", ["filters.activity"] = "Hoat dong", ["settings.title"] = "CAI DAT", ["settings.language"] = "Ngon ngu",
                ["resource.noMatchingTitle"] = "Khong co tai nguyen phu hop", ["resource.loadingTitle"] = "Dang tai tai nguyen", ["source.noSession"] = "Chua chon phien Kubernetes.", ["status.settingsSaved"] = "Da luu cai dat."
            }),
            ...
            {
                ["nav.search"] = "Sok", ["nav.resources"] = "RESURSER", ["nav.graph"] = "GRAF", ["nav.events"] = "HANDELSER", ["nav.ports"] = "PORTAR", ["nav.settings"] = "INSTALLNINGAR",
                ["filters.title"] = "FILTER", ["filters.problems"] = "Problem", ["filters.activity"] = "Aktivitet", ["settings.title"] = "INSTALLNINGAR", ["settings.language"] = "Sprak",
                ["resource.noMatchingTitle"] = "Inga matchande resurser", ["resource.loadingTitle"] = "Laddar resurser", ["source.noSession"] = "Ingen Kubernetes-session vald.", ["status.settingsSaved"] = "Installningar sparade."
            })
        };
    ...
    private static IReadOnlyDictionary<string, string[]> CommonUiPacks() =>
        ...
        {
            ["de"] = ["Quellen", "Darstellung", "Grafik", "Synchronisierung", "Arbeitsbereich", "Privatsphare", "Diagnose", "Theme", "Variante", "Theme-Starke", "Sprache", "Radarwasser", "Radarwasser-Tempo", "Animationsstarke", "Warnungen folgen", "Radar-Bildschirmschoner", "Sync im Hintergrund", "Anfragelimit", "Arbeitsbereich wiederherstellen", "Telemetrie", "ANFRAGEPROTOKOLL (LETZTE 256)", "SERVERSEITIG ANWENDEN", "ZURUCKSETZEN", "PORT", "Ubersicht", "YAML", "Ereignisse", "Links", "Logs", "Werte", "PORT-FORWARD", "Container-Port", "Lokaler Port"],
            ["es"] = ["Fuentes", "Apariencia", "Graficos", "Sincronizacion", "Espacio", "Privacidad", "Diagnostico", "Tema", "Variante", "Intensidad del tema", "Idioma", "Agua del radar", "Velocidad del agua", "Intensidad de animacion", "Seguir alertas", "Salvapantallas radar", "Sync inactiva", "Limite de solicitudes", "Restaurar espacio", "Telemetria", "REGISTRO DE SOLICITUDES (ULTIMAS 256)", "APLICAR EN SERVIDOR", "RESTABLECER", "PUERTO", "Resumen", "YAML", "Eventos", "Enlaces", "Logs", "Valores", "REENVIO DE PUERTO", "Puerto contenedor", "Puerto local"],
            ["fr"] = ["Sources", "Apparence", "Graphismes", "Synchro", "Espace de travail", "Confidentialite", "Diagnostic", "Theme", "Variante", "Intensite du theme", "Langue", "Eau radar", "Vitesse de l'eau", "Intensite animation", "Suivre les alertes", "Veille radar", "Synchro inactive", "Limite de requetes", "Restaurer l'espace", "Telemetrie", "JOURNAL DES REQUETES (256 DERNIERES)", "APPLIQUER COTE SERVEUR", "REINITIALISER", "PORT", "Vue", "YAML", "Evenements", "Liens", "Logs", "Valeurs", "REDIRECTION DE PORT", "Port conteneur", "Port local"],
            ["pt-BR"] = ["Fontes", "Aparencia", "Graficos", "Sincronizacao", "Area de trabalho", "Privacidade", "Diagnosticos", "Tema", "Variante", "Intensidade do tema", "Idioma", "Agua do radar", "Velocidade da agua", "Intensidade da animacao", "Seguir alertas", "Protecao de tela radar", "Sync inativo", "Limite de requisicoes", "Restaurar area", "Telemetria", "LOG DE REQUISICOES (ULTIMAS 256)", "APLICAR NO SERVIDOR", "REDEFINIR", "PORTA", "Visao geral", "YAML", "Eventos", "Links", "Logs", "Valores", "REDIRECIONAMENTO DE PORTA", "Porta do container", "Porta local"],
            ["it"] = ["Sorgenti", "Aspetto", "Grafica", "Sincronizzazione", "Workspace", "Privacy", "Diagnostica", "Tema", "Variante", "Intensita tema", "Lingua", "Acqua radar", "Velocita acqua", "Intensita animazione", "Segui avvisi", "Salvaschermo radar", "Sync inattiva", "Limite richieste", "Ripristina workspace", "Telemetria", "LOG RICHIESTE (ULTIME 256)", "APPLICA SERVER-SIDE", "REIMPOSTA", "PORTA", "Panoramica", "YAML", "Eventi", "Collegamenti", "Log", "Valori", "PORT FORWARD", "Porta container", "Porta locale"],
            ...
            ["pl"] = ["Zrodla", "Wyglad", "Grafika", "Synchronizacja", "Obszar roboczy", "Prywatnosc", "Diagnostyka", "Motyw", "Wariant", "Intensywnosc motywu", "Jezyk", "Woda radaru", "Predkosc wody", "Intensywnosc animacji", "Sledz alerty", "Wygaszacz radaru", "Sync nieaktywny", "Limit zadan", "Przywroc obszar", "Telemetria", "DZIENNIK ZADAN (OSTATNIE 256)", "ZASTOSUJ NA SERWERZE", "RESETUJ", "PORT", "Przeglad", "YAML", "Zdarzenia", "Linki", "Logi", "Wartosci", "PRZEKIEROWANIE PORTU", "Port kontenera", "Port lokalny"],
            ...
            ["tr"] = ["Kaynaklar", "Gorunum", "Grafikler", "Senkron", "Calisma alani", "Gizlilik", "Tani", "Tema", "Varyant", "Tema yogunlugu", "Dil", "Radar suyu", "Su hizi", "Animasyon yogunlugu", "Uyarilari izle", "Radar ekran koruyucu", "Pasif senkron", "Istek limiti", "Calisma alanini geri yukle", "Telemetri", "ISTEK GUNLUGU (SON 256)", "SUNUCUDA UYGULA", "SIFIRLA", "PORT", "Genel bakis", "YAML", "Olaylar", "Baglantilar", "Loglar", "Degerler", "PORT YONLENDIRME", "Konteyner portu", "Yerel port"],
            ...
            ["vi"] = ["Nguon", "Giao dien", "Do hoa", "Dong bo", "Khong gian lam viec", "Rieng tu", "Chan doan", "Chu de", "Bien the", "Cuong do chu de", "Ngon ngu", "Nuoc radar", "Toc do nuoc", "Cuong do hoat anh", "Theo doi canh bao", "Bao ve man hinh radar", "Dong bo khi ranh", "Gioi han yeu cau", "Khoi phuc workspace", "Telemetry", "NHAT KY YEU CAU (256 GAN NHAT)", "AP DUNG PHIA MAY CHU", "DAT LAI", "CONG", "Tong quan", "YAML", "Su kien", "Lien ket", "Nhat ky", "Gia tri", "CHUYEN TIEP CONG", "Cong container", "Cong cuc bo"],
            ...
            ["sv"] = ["Kallor", "Utseende", "Grafik", "Synk", "Arbetsyta", "Integritet", "Diagnostik", "Tema", "Variant", "Temastyrka", "Sprak", "Radarvatten", "Vattenhastighet", "Animationsstyrka", "Folj varningar", "Radar skarmslackare", "Inaktiv synk", "Begaransgrans", "Aterstall arbetsyta", "Telemetri", "BEGARANSLOGG (SENASTE 256)", "TILLAMPA PA SERVERN", "ATERSTALL", "PORT", "Oversikt", "YAML", "Handelser", "Lankar", "Loggar", "Varden", "PORTVIDAREBEFORDRAN", "Containerport", "Lokal port"]
        };
}
