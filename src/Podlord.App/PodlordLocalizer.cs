...
public static class PodlordLocalizer
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["sources.searchPlaceholder"] = "search by name or path",
        ...
        ["tooltip.useSource"] = "Open this session in a tab",
        ["tooltip.openSessionInTab"] = "Open session in a tab",
        ["tooltip.openSessionInWindow"] = "Open session in a new window",
        ["tooltip.detachSessionTab"] = "Move session to its own window",
        ["tooltip.closeSessionTab"] = "Close session tab",
