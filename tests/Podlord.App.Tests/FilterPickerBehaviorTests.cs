...
public sealed class FilterPickerBehaviorTests
{
    ...
    public void Main_window_uses_sources_menu_without_duplicate_session_button()
    {
        ...
        Assert.Contains("RadarAutoFollowAlertsSetting", window, StringComparison.Ordinal);
        ...
        Assert.Contains("Text=\"{Binding RadarAutoFollowHelpText}\"", window, StringComparison.Ordinal);
        ...
        Assert.Contains("[\"settings.radarAutoFollow\"] = \"Auto-follow alerts\"", localizer, StringComparison.Ordinal);
        ...
        Assert.Contains("MenuItemToggleType.CheckBox", codeBehind, StringComparison.Ordinal);
        ...
        Assert.Contains("RadarAutoFollowAlertsSetting", viewModel, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("IterationCount=\"Infinite\"", app, StringComparison.Ordinal);
        Assert.Contains("<Animation Duration=\"0:0:1.2\" IterationCount=\"3\">", app, StringComparison.Ordinal);
